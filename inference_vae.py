...
from meshflow.utils.dtype import AUTOCAST_DTYPE_CHOICES, resolve_torch_dtype, torch_dtype_to_name
...
def main():
    ...
    print(
        f"  sample_posterior={sample_posterior} dynamic_latent={dynamic_latent} "
        f"device={device} dtype={torch_dtype_to_name(dtype)}"
    )
